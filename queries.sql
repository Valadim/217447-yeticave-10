...
INSERT INTO `lot` (`id`, `date`, `name`, `description`, `img_path`, `start_price`, `finish_date`, `bid_step`, `user_id`, `category_id`, `is_active`)
VALUES (NULL, CURRENT_TIMESTAMP, '2014 Rossignol District Snowboard', 'Описание товара', '../img/lot-1.jpg', '10999', '2019-09-28 12:28:05', '1000', '1', '1', '1');

INSERT INTO `lot` (`id`, `date`, `name`, `description`, `img_path`, `start_price`, `finish_date`, `bid_step`, `user_id`, `category_id`, `is_active`)
VALUES (NULL, CURRENT_TIMESTAMP, 'DC Ply Mens 2016/2017 Snowboard', 'Описание товара', '../img/lot-2.jpg', '15999', '2019-09-12 09:28:05', '1000', '2', '1', '1');

INSERT INTO `lot` (`id`, `date`, `name`, `description`, `img_path`, `start_price`, `finish_date`, `bid_step`, `user_id`, `category_id`, `is_active`)
VALUES (NULL, CURRENT_TIMESTAMP, 'Крепления Union Contact Pro 2015 года размер L/XL', 'Описание товара', '../img/lot-3.jpg', '8000', '2019-10-02 22:35:05', '1000', '3', '2', '1');

INSERT INTO `lot` (`id`, `date`, `name`, `description`, `img_path`, `start_price`, `finish_date`, `bid_step`, `user_id`, `category_id`, `is_active`)
VALUES (NULL, CURRENT_TIMESTAMP, 'Ботинки для сноуборда DC Mutiny Charocal', 'Описание товара', '../img/lot-4.jpg', '10999', '2019-09-29 02:08:05', '1000', '4', '3', '1');

INSERT INTO `lot` (`id`, `date`, `name`, `description`, `img_path`, `start_price`, `finish_date`, `bid_step`, `user_id`, `category_id`, `is_active`)
VALUES (NULL, CURRENT_TIMESTAMP, 'Куртка для сноуборда DC Mutiny Charocal', 'Описание товара', '../img/lot-5.jpg', '10999', '2019-09-14 19:00:00', '1000', '3', '4', '1');

INSERT INTO `lot` (`id`, `date`, `name`, `description`, `img_path`, `start_price`, `finish_date`, `bid_step`, `user_id`, `category_id`, `is_active`)
VALUES (NULL, CURRENT_TIMESTAMP, 'Маска Oakley Canopy', 'Описание товара', '../img/lot-6.jpg', '5500', '2019-10-08 11:36:47', '1000', '1', '6', '1');
